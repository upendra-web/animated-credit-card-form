(function () {
  ...
  const { setFormData: setFormData$3 } = formUtils;
  ...
  const setupCardNumberField = () => {
    ...
    cardNoField.onkeypress = (e) => {
      ...
      if (isCCNumber && btwnLen) {
        setFormData$3(setFormData$3('cardNo', e.target.value));
  ...
  const { setFormData: setFormData$2 } = formUtils;
  ...
  const setupCVVField = () => {
    ...
    cvvField.onkeypress = (e) => {
      ...
      if (isNumber && btwnLen) {
        setFormData$2(setFormData$2('cvv', e.target.value));
        return true;
      }
  ...
  const { setFormData: setFormData$1 } = formUtils;
  ...
  const setupCardNameField = () => {
    ...
    cardNameField.onkeypress = (e) => {
      ...
      if (isCCName && btwnLen) {
        setFormData$1(setFormData$1('cardName', e.target.value));
        return true;
      }
